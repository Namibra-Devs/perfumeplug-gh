...
const ProductCard: React.FC<ProductCardProps> = ({ product, viewMode = 'grid', key: cardKey }) => {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.3 }}
      className="h-[400px] sm:h-[500px] group rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer bg-white border border-gray-100"
      onClick={handleCardClick}
    >
