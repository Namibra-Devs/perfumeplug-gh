      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-32">
        ...
        >
          ...
          >
            ...
            <button
              onClick={goToPrev}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-black/50 backdrop-blur-sm hover:bg-black/70 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
            ...
            <button
              onClick={goToNext}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-black/50 backdrop-blur-sm hover:bg-black/70 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
                    ...
                    >
                      ...
                      <div className="aspect-square relative overflow-hidden">
                        ...
                        <div className="absolute top-4 right-4">
                          <div className={`w-12 h-12 bg-gradient-to-r ${category.color} rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                            {category.icon}
                          </div>
                        </div>
